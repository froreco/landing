!(function (e, t) {
  ...
  const s = {
      ...
      jsFolder: "https://cdn.frore.co/js/",
      cssFolder: "https://cdn.frore.co/css/",
    },
    d = {
      baseEl: document,
    ...
    l = {
      ...
      breakpoints: () => {
        ...
        Object.keys(r).forEach((e) => {
          t > r[e].enter && t <= r[e].exit
            ...
            t <= r[e].exit &&
              "" != i &&
              d.elBody.classList.add("device-down-" + i),
            (i = e),
            t > r[e].enter
      ...
      imagesLoaded: (e) => {
        ...
        async function o() {
          i++, i === r && l.addEvent(e, "CanvasImagesLoaded");
        }
      ...
      contains: (e, t) => {
        ...
        return (
          r.forEach((e) => {
            d.elBody.classList.contains(e) && (i = !0);
          }),
          i
        );
      },
      ...
      loadCSS: (e) => {
        ...
        return (
          (i.id = r),
          (i.href = e ? s.cssFolder + t : t),
          (i.rel = "stylesheet"),
          (i.type = "text/css"),
          d.elHead.appendChild(i),
          !0
        );
      },
      loadJS: (e) => {
        ...
        if (void 0 !== o) {
          if ("function" != typeof o) throw new Error("Not a valid callback!");
          a.onload = o;
        }
        return (
          (a.id = r),
      ...
      runModule: (t) => {
        var e =
          ...
          "https:" == window.location.protocol
            ? "fn"
            : "module";
        let r = ("fn" == e ? s.jsFolder : "./") + e + "." + t.plugin + ".js";
        return (
          t.file && (r = t.file),
          "module" == e
            ? import(r)
            ...
            : (e = () => void 0 !== l.getVars.fn[t.plugin])()
            ? l.getVars.fn[t.plugin](t.selector)
            : (l.loadJS({ file: r, id: "canvas-" + t.plugin + "-fn" }),
              l
                .isFuncTrue(e)
                .then((e) => !!e && void l.getVars.fn[t.plugin](t.selector))),
          !0
        );
      },
      initModule: (t) => {
  ...
  return (
    ...
    { Core: l, Base: e, Modules: t, Mobile: r, Custom: i }
  );
});
